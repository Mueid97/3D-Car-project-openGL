...
void display_string(int x, int y, char *string, int font)    /* The main drawing function*/
{
    int len,i;
...
void display1(void)
{
	...
	display_string(180,540,"Pabna University of Science & Technology",1); //correct cordinate according to name
